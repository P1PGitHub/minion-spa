<template>
  <div class="flex flex-col items-center">
    ...
    <div class="p-4 text-gray-800 space-y-4 container">
      <div class="flex items-center p-4 bg-gray-200 rounded">
        <p>
          ...
          insight into the scope and frequency of our work with specific
          clients. Without the CSQR, our work has no story.
        </p>
      </div>
      <div>
        <div
        ...
        <div class="text-base">
          <div
            ...
            :class="{ 'border-none': index == recents.length - 1 }"
          >
            <div class="flex items-center justify-between">
              <h3 class="font-bold">{{ recent.company_name }}</h3>
              <div class="py-1 px-2 bg-gray-600 rounded" v-if="recent.billable">
                <img
            ...
            <h5 class="text-gray-700">{{ recent.client_name }}</h5>
